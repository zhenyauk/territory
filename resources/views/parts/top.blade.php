...
<nav class="site-navbar navbar navbar-inverse navbar-fixed-top navbar-mega navbar-inverse"
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand navbar-brand-center" href="index.html">
            <img class="navbar-brand-logo navbar-brand-logo-normal" src="/material/images/logo.png"
                 title="Material">
            <img class="navbar-brand-logo navbar-brand-logo-special" src="/material/images/logo-blue.png"
                 title="Material">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar">
                ...
                <li class="dropdown dropdown-fw dropdown-mega">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"
                       data-animation="fade" role="button">Мегаменю <i class="icon md-chevron-down" aria-hidden="true"></i></a>
                                        ...
                                        <ul class="blocks-3">
                                            <li>
                                                <a class="thumbnail margin-0" href="javascript:void(0)">
                                                    <img class="width-full" src="/material/images/placeholder.png" alt="..."
                                                    />
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-collapse collapse" id="siteMegaCollapseOne" aria-labelledby="siteMegaAccordionHeadingOne"
                                                    ...
                                                    <div class="panel-body">
                                                        Товарищи! начало повседневной работы по формированию позиции в значительной степени
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
              ...
              <span class="avatar avatar-online">
                <img src="/material/images/5.jpg" alt="...">
                <i></i>
              </span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation">
                            <a href="javascript:void(0)" role="menuitem"><i class="icon md-power" aria-hidden="true"></i> Выход</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
                        ...
                        <li class="list-group" role="presentation">
                          ...
                          <span class="avatar avatar-sm avatar-online">
                            <img src="/material/images/2.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-off">
                            <img src="/material/images/3.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                                                ...
                                                <div class="media-detail">FriendlyCMS работает с Яндекс.Маркет!</div>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="list-group-item" href="http://bleaksoft.ru/news/%D0%BD%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8%20friendlycms" target="_blank" role="menuitem">
                          ...
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="/material/images/4.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-away">
                            ...
                            <i></i>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-detail">Быстрое оформление заказа - это радует!</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                        ...
                                        <div>
                                            <ul class="site-menu-sub site-menu-section-list">
                                                ...
                                                <li class="site-menu-item has-sub">
                                                    ...
                                                    <ul class="site-menu-sub">
                                                        <li class="site-menu-item">
                                                            <a class="animsition-link" href="editor-summernote.html">
